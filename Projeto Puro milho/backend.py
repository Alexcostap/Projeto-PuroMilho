...
# qtdRetornoMilhoCozido = int(input("Insira a quatidade de milho Cozido que está retornando: "))
# qtdRetornoPamonha = int(input("Insira a quatidade de Pamonha que está retornando: "))
# qtdRetornoCanjica = int(input("Insira a quatidade de canjica que está retornando: "))
